...
for (let i = 1; i <= totalImages; i++) {
  images.push({
    src: `fondos/comics${i}.jpg`,
    srcset: `fondos/comics${i}.jpg 480w, fondos/comics${i}.png 800w, fondos/comics${i}.jpg 1200w`, // mismo src como ejemplo
    sizes: '(max-width: 600px) 100vw, 120px',
    alt: `Wallpaper comics ${i}`
  });
}

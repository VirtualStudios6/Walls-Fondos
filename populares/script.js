...
const totalImages = 82; // Cambia según cuántas tengas
const images = [];
let currentIndex = 0;
...
for (let i = 1; i <= totalImages; i++) {
  images.push({
    src: `fondos/popular${i}.jpg`,
    srcset: `fondos/popular${i}.jpg 480w, fondos/popular${i}.png 800w, fondos/popular${i}.jpg 1200w`, // mismo src como ejemplo
    sizes: '(max-width: 600px) 100vw, 120px',
    alt: `Wallpaper popular ${i}`
  });
}

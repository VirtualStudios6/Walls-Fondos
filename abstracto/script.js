...
const totalImages = 34; // Cambia según cuántas tengas
const images = [];
let currentIndex = 0;
...
for (let i = 1; i <= totalImages; i++) {
  images.push({
    src: `fondos/abstracto${i}.jpg`,
    srcset: `fondos/abstracto${i}.jpg 480w, fondos/abstracto${i}.jpg 800w, fondos/abstracto${i}.jpg 1200w`, // mismo src como ejemplo
    sizes: '(max-width: 600px) 100vw, 120px',
    alt: `Wallpaper Abstracto ${i}`
  });
}

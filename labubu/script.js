...
const totalImages = 19; // Cambia según cuántas tengas
const images = [];
let currentIndex = 0;
...
for (let i = 1; i <= totalImages; i++) {
  images.push({
    src: `fondos/labubu${i}.jpg`,
    srcset: `fondos/labubu${i}.jpg 480w, fondos/labubu${i}.png 800w, fondos/labubu${i}.jpg 1200w`, // mismo src como ejemplo
    sizes: '(max-width: 600px) 100vw, 120px',
    alt: `Wallpaper labubu ${i}`
  });
}

...
const totalImages = 120; // Cambia según cuántas tengas
const images = [];
let currentIndex = 0;
...
for (let i = 1; i <= totalImages; i++) {
  images.push({
    src: `fondos/random${i}.jpg`,
    srcset: `fondos/random${i}.jpg 480w, fondos/random${i}.png 800w, fondos/random${i}.jpg 1200w`, // mismo src como ejemplo
    sizes: '(max-width: 600px) 100vw, 120px',
    alt: `Wallpaper random ${i}`
  });
}

...
for (let i = 1; i <= totalImages; i++) {
  images.push({
    src: `fondos/animales${i}.jpg`,
    srcset: `fondos/animales${i}.jpg 480w, fondos/animales${i}.jpg 800w, fondos/animales${i}.jpg 1200w`, // mismo src como ejemplo
    sizes: '(max-width: 600px) 100vw, 120px',
    alt: `Wallpaper animales ${i}`
  });
}

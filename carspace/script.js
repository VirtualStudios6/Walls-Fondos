...
const totalImages = 20; // Cambia según cuántas tengas
const images = [];
let currentIndex = 0;
...
for (let i = 1; i <= totalImages; i++) {
  images.push({
    src: `fondos/carspace${i}.png`,
    srcset: `fondos/carspace${i}.png 480w, fondos/carspace${i}.png 800w, fondos/carspace${i}.png 1200w`, // mismo src como ejemplo
    sizes: '(max-width: 600px) 100vw, 120px',
    alt: `Wallpaper carspace ${i}`
  });
}

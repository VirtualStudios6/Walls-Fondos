...
for (let i = 1; i <= totalImages; i++) {
  images.push({
    src: `fondos/paisaje${i}.jpg`,
    srcset: `fondos/paisaje${i}.jpg 480w, fondos/paisaje${i}.png 800w, fondos/paisaje${i}.jpg 1200w`, // mismo src como ejemplo
    sizes: '(max-width: 600px) 100vw, 120px',
    alt: `Wallpaper paisaje ${i}`
  });
}

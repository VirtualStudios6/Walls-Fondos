...
const totalImages = 30; // Cambia según cuántas tengas
const images = [];
let currentIndex = 0;
...
for (let i = 1; i <= totalImages; i++) {
  images.push({
    src: `fondos/deporte${i}.jpg`,
    srcset: `fondos/deporte${i}.jpg 480w, fondos/deporte${i}.png 800w, fondos/deporte${i}.jpg 1200w`, // mismo src como ejemplo
    sizes: '(max-width: 600px) 100vw, 120px',
    alt: `Wallpaper deporte ${i}`
  });
}

...
for (let i = 1; i <= totalImages; i++) {
  images.push({
    src: `fondos/coches${i}.jpg`,
    srcset: `fondos/coches${i}.jpg 480w, fondos/coches${i}.png 800w, fondos/coches${i}.jpg 1200w`, // mismo src como ejemplo
    sizes: '(max-width: 600px) 100vw, 120px',
    alt: `Wallpaper coches ${i}`
  });
}

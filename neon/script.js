...
const totalImages = 18; // Cambia según cuántas tengas
const images = [];
let currentIndex = 0;
...
for (let i = 1; i <= totalImages; i++) {
  images.push({
    src: `fondos/neon${i}.jpg`,
    srcset: `fondos/neon${i}.jpg 480w, fondos/neon${i}.png 800w, fondos/neon${i}.jpg 1200w`, // mismo src como ejemplo
    sizes: '(max-width: 600px) 100vw, 120px',
    alt: `Wallpaper neon ${i}`
  });
}

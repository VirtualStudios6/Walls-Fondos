...
const totalImages = 24; // Cambia según cuántas tengas
const images = [];
let currentIndex = 0;
...
for (let i = 1; i <= totalImages; i++) {
  images.push({
    src: `fondos/aesthetic${i}.jpg`,
    srcset: `fondos/aesthetic${i}.jpg 480w, fondos/aesthetic${i}.jpg 800w, fondos/aesthetic${i}.jpg 1200w`, // mismo src como ejemplo
    sizes: '(max-width: 600px) 100vw, 120px',
    alt: `Wallpaper aesthetic ${i}`
  });
}
